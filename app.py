...
if user_input:
    ...
    st.session_state.generated.append('Psy Bot: '+output)
...
message('Psy Bot: I am Psychologist Bot or Psy Bot for short. I will answer your queries about mental health.')
